			...
			<div class="titulo h5 mb-0"><h2>Formulario de cadastro</h2></div>
				<div class="base-form">
					<div class="caixa-form">
						<form action="<?php echo URL_BASE."carro/salvar" ?>" method="POST">				
							<div class="rows">
							...
							<div class="rows msg-form">	
							  <div class="col-3 position-relative">									
								...
								<div class="rows">
								    <div class="col-8">
										<label>Nome</label>
										<input name="nome" value="<?php echo isset($carro) ? $carro->nome : ""  ?>" type="text" placeholder="Insira um nome" class="form-campo">
									</div>
								<div class="col-4">
									<label>Marca</label>
									<input name="marca" value="<?php echo isset($carro) ? $carro->marca : ""  ?>" type="text" placeholder="Insira sua marca" class="form-campo">
								</div>									
									<div class="col-3">
										<label>Cor</label>
										<input name="cor" value="<?php echo isset($carro) ? $carro->cor : ""  ?>" type="text" placeholder="Insira a cor" class="form-campo">
									</div>					
														
																
								
								<div class="col-4 m-auto">
									<input type="hidden" name="idcarro" value="<?php echo isset($carro) ? $carro->idcarro : ""  ?>" />
