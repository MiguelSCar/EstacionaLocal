			...
			<div class="titulo h5 mb-0"><h2>Formulario de cadastro</h2></div>
				<div class="base-form">
					<div class="caixa-form">
						<form action="<?php echo URL_BASE."vaga/salvar" ?>" method="POST">				
							<div class="rows">
							...
							<div class="rows msg-form">	
							  <div class="col-3 position-relative">									
								...
								<div class="rows">
								    <div class="col-8">
										<label>Estado</label>
										<input name="estado" value="<?php echo isset($vaga) ? $vaga->estado : ""  ?>" type="text" placeholder="Insira um nome" class="form-campo">
									</div>
								<div class="col-4">
									<label>Preferencial</label>
									<input name="preferencial" value="<?php echo isset($vaga) ? $vaga->preferencial : ""  ?>" type="text" placeholder="Insira sua marca" class="form-campo">
								</div>									
								...
								<div class="col-4 m-auto">
									<input type="hidden" name="idvaga" value="<?php echo isset($vaga) ? $vaga->idvaga : ""  ?>" />
